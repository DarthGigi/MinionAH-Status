        ...
        <div class="grid grid-cols-12">
            ...
            <div class="chart-status relative mt-1 col-span-12">
                <div class="flex overflow-x-auto daygrid90 overflow-y-hidden py-1">
                    ...
                    <div class="h-[30px] w-[6px] rounded-[0.0625rem] oneline">
                        <div class="h-[30px] bg-{bar.cssClass} w-[4px] rounded-[0.0625rem] mr-[2px]"></div>
                    </div>
                    <div class="absolute show-hover text-sm bg-background rounded">
                        <div class="text-{bar.cssClass} font-semibold p-1">
            ...
            <div class="chart-status relative mt-1 mb-4 col-span-12">
                <div class="flex flex-wrap today-sq-div">
                    ...
                    <div data-index="{bar.index}" class="h-[10px] bg-{bar.cssClass} rounded-[0.125rem] w-[10px] today-sq m-[1px]"></div>
